...
<div className="container">
  ...
  <div className="form-group"  style={{marginLeft:'-80px', color:'black'}}>
    ...
    <input type="text" className="form-control col-7" name="uname" value={uname} onChange={this.changeHandler} />
 
  </div>
  <div className="form-group"  style={{marginLeft:'-80px', color:'black'}}>
    <label  style={{fontSize:'18px', letterSpacing:'2px',fontWeight: 'bold'}}  >Code</label>
 
    <input type="email" className="form-control col-7" name="email" value={email}  onChange={this.changeHandler} />
  </div>
  <div className="form-group"  style={{marginLeft:'-80px' , color:'black'}}>
    <label  style={{fontSize:'18px', letterSpacing:'2px',fontWeight: 'bold'}}  >Brand</label>
 
    <input type="number" className="form-control col-7"  name="phone" value={phone}  onChange={this.changeHandler} />
  ...
  <div className="form-group"  style={{marginLeft:'-80px', color:'black'}}>
    ...
    <input type="text" className="form-control col-7" name="comments" value={comments}  onChange={this.changeHandler} />
 
  </div>

 <div>
  <button type="submit" className="btn btn-primary col-7" style={{backgroundColor:'#f0f4c3',borderColor:'#f0f4c3', color: 'black', marginLeft:'-60px'}} 
